...
int main() {
    try {
        Vector2D v1; // Конструктор по умолчанию (x = 0, y = 0)
        Vector2D v2(3.0, 4.0); // Параметризированный конструктор (вектор с заданными координатами)

        // Выводим значения векторов v1 и v2 на консоль
        ...
        // Обрабатываем исключения, если координаты вектора некорректные
